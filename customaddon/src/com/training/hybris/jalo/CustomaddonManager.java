 ...
 */
package com.training.hybris.jalo;
...
import com.training.hybris.constants.CustomaddonConstants;



/**
 * This is the extension manager of the Customaddon extension.
 */
public class CustomaddonManager extends GeneratedCustomaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustomaddonManager.class.getName());
	 ...
	 */
	public static CustomaddonManager getInstance()
	{
		return (CustomaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CustomaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
