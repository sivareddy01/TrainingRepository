 ...
 */
package com.training.hybris.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String TrainingProductListComponent = _Prefix + TrainingProductListComponentModel._TYPECODE + _Suffix; // NOSONAR
